...
const handleSingUp = async(e)=>{
  ...
  return (
    ...
    <div className="relative w-full h-screen overflow-hidden flex justify-center items-center ">
      ...
      />
      <form className="w-[80%] h-150 max-w-125 bg-[#0000005e] shadow-lg shadow-black rounded-2xl backdrop-blur-lg flex flex-col items-center gap-5 justify-center px-8 relative z-10 " onSubmit={handleSingUp}>
...
*{err}
  ...
  >
    {showPassword ? <FiEyeOff size={20} /> : <FiEye size={20} />}
        ...
        <button className=" mt-5 min-w-80 h-15  bg-white rounded-4xl text-3xl font-bold text-blue-500 border-2 border-blue-500"disabled={loading}>{loading?"loading..":"Sign Up"}</button>
        <p className="text-white text-xl mt-10 cursor-pointer " onClick={()=>navigate("/signin")}>Already have a account ?<span className="text-blue-500"> Sign In</span></p>
      </form>
    </div>
